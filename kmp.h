...
struct kmp_node_info {
  ...
  kmp_int64 exe_time; //Execution time
};
...
typedef struct kmp_base_thread_data {
  ...
  kmp_int64 tot_exe_time = 0; // Total execution time of tasks in deque
#ifdef BUILD_TIED_TASK_STACK
...
KMP_EXPORT void __kmpc_thread_sched(kmp_int32 period, kmp_int32 deadline, kmp_int32 runtime);
